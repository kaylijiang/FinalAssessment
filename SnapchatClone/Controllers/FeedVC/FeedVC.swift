...
class FeedVC: UIViewController, VCDelegate  {
    ...
    func setupArrayOfSnaps() {
        arrayOfSnaps = []
        /* PART 2B START */
        //Firebase.getSnapsID <-- something like this about getting the id's and then you'd append those to the array of Snaps because they're references to the snaps
